...
MODEL_PATH = "/home/admin/bus-manager-counter/models/passenger-urban-bus--640x640_quant_hailort_multidevice_1.hef"
MODEL_NAME = "passenger-urban-bus--640x640_quant_hailort_multidevice_1.hef"
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        default="false",
        help="En vez de seleccionar la cámara por RTSP, seleccionar por otro medio"
    )
    args = parser.parse_args()

    # Convertir a booleanos
    show_window = args.show.lower() in ["true", "1", "yes", "y"]
    test_mode = args.test.lower() in ["true", "1", "yes", "y"]

    # Pasar ambos argumentos a main()
    main(show_window=show_window, test_mode=test_mode)
